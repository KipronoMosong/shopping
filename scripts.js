...
function submitForm(e) {
  ...
  saveMessages(name, emailid, Phone_Number,Facebook,Instagram,file,latitude,longitude);
...
const saveMessages = (name, emailid, Phone_Number,Facebook,Instagram,file,latitude,longitude) => {
